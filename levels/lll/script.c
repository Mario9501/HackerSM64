...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		MARIO_POS(0x01, 0, -2100, 800, 0),
		OBJECT(MODEL_NONE, 0, 800, 0, 0, 0, 0, 0x00000000, bhvInitializeChangingWaterLevel),
		OBJECT(MODEL_NONE, -2100, 800, 0, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_WDW_WATER_LEVEL_DIAMOND, 2400, 1200, -700, 0, 0, 0, 0x00000000, bhvWaterLevelDiamond),
		OBJECT(MODEL_WDW_WATER_LEVEL_DIAMOND, 0, 2063, -1370, 0, 0, 0, 0x00000000, bhvWaterLevelDiamond),
		OBJECT(MODEL_WDW_WATER_LEVEL_DIAMOND, 5000, -50, -6200, 0, 0, 0, 0x00000000, bhvWaterLevelDiamond),
